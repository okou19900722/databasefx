...
////
////    @Override
////    public void addChange(RowChangeModel.ChangeType changeType, TableColumnMeta columnMeta, int rowIndex, String fieldName, String oldValue, String newValue, RowChangeModel.OperationType operationType) {
...
////            //update row
////            if (changeType == RowChangeModel.ChangeType.DELETE && model.getChangeType() == RowChangeModel.ChangeType.CREATE) {
...
////            }
////        } else {
////            var rowChange = new RowChangeModel( _rowIndex, changeType, operationType,columnMeta);
...
////     */
////    public int getRealRowIndex(final int rowIndex) {
